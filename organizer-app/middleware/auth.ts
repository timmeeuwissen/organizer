...
export default defineNuxtRouteMiddleware((to, from) => {
  ...
  // Demo mode: only active when both VITE_AUTH_BYPASS=true AND running in dev build.
  // localStorage cannot grant bypass — it is user-controlled and therefore untrusted.
