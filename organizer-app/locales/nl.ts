export default {
  ...
  settings: {
    ...
    pop3: 'POP3',
    todoist: 'Todoist',
    todoistApiToken: 'Todoist API-token',
    todoistApiTokenHint: 'Vind je token op todoist.com → Instellingen → Integraties → Ontwikkelaar',
    todoistTasksOnly: 'Todoist is een integratie alleen voor taken.',
  ...
  mail: {
    ...
    trash: 'Prullenbak',
    compose: 'Opstellen',
    sendFrom: 'Verzenden als',
    bodyFormat: 'Berichtindeling',
    richText: 'Rich Text',
    plainText: 'Platte tekst',
    signature: 'Handtekening',
    signatures: 'E-mailhandtekeningen',
    addSignature: 'Handtekening toevoegen',
    noSignaturesConfigured: 'Nog geen handtekeningen ingesteld.',
    signatureName: 'Naam handtekening',
    signatureContent: 'Inhoud handtekening',
    newSignature: 'Nieuwe handtekening',
    defaultBodyFormat: 'Standaard indeling',
    defaultSendFrom: 'Standaard afzenderaccount',
    defaultSignature: 'Standaard handtekening',
    to: 'Aan',
    cc: 'CC',
    bcc: 'BCC',
    subject: 'Onderwerp',
