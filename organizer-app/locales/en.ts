export default {
  ...
  settings: {
    ...
    todoistApiTokenHint: 'Find your token at todoist.com → Settings → Integrations → Developer',
    todoistTasksOnly: 'Todoist is a task-only integration.',
  ...
  meetings: {
    ...
    subject: 'Subject',
    action: 'Action Items',
    planThisMeeting: 'Plan this meeting',
    ...
    periodLastQuarter: 'Last 3 months',
  ...
  mail: {
    ...
    compose: 'Compose',
    sendFrom: 'Send from',
    bodyFormat: 'Message format',
    richText: 'Rich Text',
    plainText: 'Plain Text',
    signature: 'Signature',
    signatures: 'Mail signatures',
    addSignature: 'Add signature',
    noSignaturesConfigured: 'No signatures configured yet.',
    signatureName: 'Signature name',
    signatureContent: 'Signature content',
    newSignature: 'New signature',
    defaultBodyFormat: 'Default format',
    defaultSendFrom: 'Default send account',
