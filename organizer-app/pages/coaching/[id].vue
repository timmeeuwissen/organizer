        ...
        <v-card-text>
          ...
          <div v-if="person" class="d-flex align-center mb-4">
            <v-avatar size="48" color="primary" class="mr-4">
              <v-icon v-if="!person.avatar" dark>
                mdi-account
              </v-icon>
        ...
        <v-window-item value="details">
                  ...
                  >
                    <v-list-item-content>
                      ...
                      <v-list-item-subtitle>
                        ...
                        <v-chip x-small :color="getPriorityColor(task.priority)" class="mr-1">
                          {{ task.priority }}
                        </v-chip>
                      </v-list-item-subtitle>
                    </v-list-item-content>
          ...
          <v-dialog v-model="deleteDialogOpen" max-width="500px">
            <v-card>
              ...
              <v-card-actions>
                <v-spacer />
                <v-btn text @click="deleteDialogOpen = false">
                  Cancel
                </v-btn>
                <v-btn color="error" text :loading="loading" @click="deleteCoaching">
                  Delete
                </v-btn>
              </v-card-actions>
            </v-card>
          ...
          <v-dialog v-model="strengthDialogOpen" max-width="500px">
            <v-card>
              ...
              <v-card-actions>
                <v-spacer />
                <v-btn text @click="strengthDialogOpen = false">
                  Cancel
                </v-btn>
                <v-btn color="primary" text @click="saveStrength">
                  Save
                </v-btn>
              </v-card-actions>
            </v-card>
          ...
          <v-dialog v-model="weaknessDialogOpen" max-width="500px">
            <v-card>
              ...
              <v-card-actions>
                <v-spacer />
                <v-btn text @click="weaknessDialogOpen = false">
                  Cancel
                </v-btn>
                <v-btn color="primary" text @click="saveWeakness">
                  Save
                </v-btn>
              </v-card-actions>
            </v-card>
          ...
          <v-dialog v-model="goalDialogOpen" max-width="500px">
            <v-card>
              ...
              <v-card-actions>
                <v-spacer />
                <v-btn text @click="goalDialogOpen = false">
                  Cancel
                </v-btn>
                <v-btn color="primary" text @click="saveGoal">
                  Save
                </v-btn>
              </v-card-actions>
            </v-card>
          ...
          <v-dialog v-model="timelineEntryDialogOpen" max-width="500px">
            <v-card>
              ...
              <v-card-actions>
                <v-spacer />
                <v-btn text @click="timelineEntryDialogOpen = false">
                  Cancel
                </v-btn>
                <v-btn color="primary" text @click="saveTimelineEntry">
                  Save
                </v-btn>
              </v-card-actions>
            </v-card>
          ...
          <v-dialog v-model="historyEntryDialogOpen" max-width="500px">
            <v-card>
              ...
              <v-card-actions>
                <v-spacer />
                <v-btn text @click="historyEntryDialogOpen = false">
                  Cancel
                </v-btn>
                <v-btn color="primary" text @click="saveHistoryEntry">
                  Save
                </v-btn>
              </v-card-actions>
            </v-card>
          ...
          <v-dialog v-model="deleteHistoryEntryDialogOpen" max-width="500px">
            <v-card>
              ...
              <v-card-actions>
                <v-spacer />
                <v-btn text @click="deleteHistoryEntryDialogOpen = false">
                  Cancel
                </v-btn>
                <v-btn color="error" text @click="deleteHistoryEntry">
                  Delete
                </v-btn>
              </v-card-actions>
            </v-card>
          ...
          <v-dialog v-model="historyDialogOpen" max-width="600px">
            <v-card>
              ...
              <v-card-actions>
                <v-spacer />
                <v-btn text @click="historyDialogOpen = false">
                  Close
                </v-btn>
              </v-card-actions>
            </v-card>
          ...
          <v-dialog v-model="addTaskDialogOpen" max-width="500px">
            <v-card>
              ...
              <v-card-actions>
                <v-spacer />
                <v-btn text @click="addTaskDialogOpen = false">
                  Cancel
                </v-btn>
                <v-btn color="primary" text @click="addRelatedTasks">
                  Add
                </v-btn>
              </v-card-actions>
            </v-card>
